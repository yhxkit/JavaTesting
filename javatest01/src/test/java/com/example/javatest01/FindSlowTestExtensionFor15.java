...
public class FindSlowTestExtensionFor15 implements BeforeTestExecutionCallback, AfterTestExecutionCallback {

    private long THRESHOLD;

    public FindSlowTestExtensionFor15(long threshold){
